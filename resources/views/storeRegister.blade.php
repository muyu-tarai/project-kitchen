...
<form action="/tmp" method="POST">
  ...
  <div class="inner-top">
    ...
    <div class="for-button">
      ...
      <label>
        <input type="file" name="store-img">写真を選択
      </label>
    </div>
  </div>
  <div class="inner-middle">
    <div>
      <h2>店舗紹介コメント</h2>
      <textarea name="store-comment" id="" cols="30" rows="10"></textarea>
    </div>
    ...
    <div class="inner-add-menu">
      <div class="add-menu-image">
        ...
        <div class="for-button">
          ...
          <label>
            <input type="file" name="menu-img">写真を選択
          </label>
        </div>
      </div>
      <div>
      ...
      <div>
        ...
        <div class="add-menu-amount">
          <input type="text" name="menu-amount">
          <p>円</p>
        </div>
      </div>
      <div>
        <h3>メニュー紹介コメント</h3>
        <textarea name="menu-comment" id="" cols="30" rows="10"></textarea>
      </div>
      <div class="for-button">
        <label>
